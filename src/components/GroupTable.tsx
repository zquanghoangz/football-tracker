      ...
      <table className="w-full table-fixed text-sm">
        <thead>
          <tr className="bg-slate-800/60 text-xs uppercase tracking-wide text-slate-400">
            <th className="px-3 py-2 text-left sticky left-0 z-20 bg-slate-800/80 w-36">Club</th>
            <th className="px-2 py-2 whitespace-nowrap">MP</th>
            ...
            <th className="px-2 py-2 font-bold text-slate-200 text-center">Pts</th>
            <th className="px-3 py-2 text-center align-middle">Last 5</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-slate-800">
          {standings.map((row) => {
            ...
            return (
              ...
              >
                <td className="px-3 py-2 text-left tabular-nums sticky left-0 z-10 bg-slate-900 w-36">
